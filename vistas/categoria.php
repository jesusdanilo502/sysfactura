                            ...
                            <form name="formulario" id="formulario" method="POST">
                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <label for="nombre">Nombre:<span
                                                class="obligatorio">  *Campo Obligatorio..</span></label>
                                    <input type="hidden" name="idcategoria" id="idcategoria" value="">
                                    <input type="text" class="form-control validar" name="nombre" id="nombre"
                                           maxlength="50" placeholder="Nombre">

                                </div>
                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <label for="descripcion">Descripción:<span class="obligatorio">  *Campo Obligatorio..</span></label>
                                    <input type="text" class="form-control validar" name="descripcion" id="descripcion"
                                           maxlength="256" placeholder="Descripción" value="">
                                </div>
                                <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button class="btn btn-primary" type="submit" id="btnGuardar" onclick="changeinput">
