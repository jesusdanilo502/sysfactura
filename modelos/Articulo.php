...
Class Articulo
{
    ...
    // tambien me llevo el precio de compra en la subconsulta para registrarlo en la tabla detalle de la venta y asi sacar mi utilidad
	public function listarActivosVenta()
	{
		$sql="SELECT a.idarticulo,a.idcategoria,c.nombre as categoria,a.codigo,
        a.nombre,a.stock,(SELECT precio_venta FROM detalle_ingreso WHERE idarticulo=a.idarticulo order by iddetalle_ingreso desc limit 0,1) as precio_venta,
