...
<html>
  <head>
    ...
    <title>SysFacturas | www.onemas.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>IT</b>SysFacturas</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>SysFacturas</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.onemas.co - Desarrollando Software

                      <a href="www.onemas.co"><small>www.onemas.co</small></a>
                    </p>
                  </li>
